...
import { ImageGenerator } from "@/constants/HomeLinksIcons"

const ImageGeneratorPage = () => {
  return (
    <>
      <Heading
        icon={<ImageGenerator width={10} height={10} />}
        title="Image Generator"
        description="Upload Your prompt to generate Image."
      />
      <div className="mt-6 shadow-sm shadow-gray-400 dark:shadow-md dark:shadow-gray-900 rounded-md">
        <form>
          <label
            htmlFor="search"
