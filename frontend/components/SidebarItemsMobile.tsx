        ...
        <ul className="space-y-4 font-medium">
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ml-3 text-left whitespace-nowrap mr-3">
                Caption Generator
              </span>
              <svg
                className={`w-3 h-3 ${
          ...
          <li onClick={closeSheet}>
            ...
            >
              ...
              <span className="ml-3">Video Generator</span>
              <span className="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">
                Pro
              </span>
            </Link>
          ...
          <li onClick={closeSheet}>
            ...
            >
              ...
              <span className="ml-3">Music Generator</span>
              <span className="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">
                Pro
              </span>
            </Link>
          ...
          <li onClick={closeSheet}>
            ...
            >
              ...
              <span className="ml-3">Code Generator</span>
              <span className="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">
                Pro
              </span>
            </Link>
...
export default SidebarItemsMobile;
