...
const HomeLinks: React.FC<LinkProp> = ({ link, title }) => {
  return (
    <div>
      <Link
        href={link}
        className="mt-3 mb-2 cursor-pointer inline-flex items-center justify-between w-full md:w-[60%] p-5 text-base font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white"
      >
        <div className="flex">
          <svg
            aria-hidden="true"
